...
namespace XH.Infrastructure.Domain.UnitOfWorks
{
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new XHException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new XHException("Complete is called before!");
            }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new XHException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }

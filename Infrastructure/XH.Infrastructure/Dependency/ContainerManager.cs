...
namespace XH.Infrastructure.Dependency
{
    ...
    public class ContainerManager : IContainerManager
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new XHException("Unknown dependency");
            ...
            throw new XHException("No constructor  was found that had all the dependencies satisfied.");
        }
        ...
        T IContainerManager.Resolve<T>()
        {
            return this.Resolve<T>();
        }

        object IContainerManager.Resolve(Type type)
        {
            return this.Resolve(type);
        }

        T[] IContainerManager.ResolveAll<T>()
        {
